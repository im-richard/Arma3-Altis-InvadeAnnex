...
_veh = "I_HMG_01_high_F" createVehicle _posicion;
_vehiculos = _vehiculos + [_veh];
_veh setPosATL _pos;
_veh setDir _dirVeh;

_grupoE = createGroup independent;

_unit = _grupoE createUnit ["I_support_MG_F", _posicion, [], 0, "NONE"];
...
_veh = createVehicle ["Flag_AAF_F", _pos, [],0, "CAN_COLLIDE"];
_vehiculos = _vehiculos + [_veh];


{_nul = [_x] spawn AAFVEHinit} forEach _vehiculos;
...
if (_conquistado) then
	...
	waitUntil {sleep 10;(dateToNumber date > _fechalimnum)};
