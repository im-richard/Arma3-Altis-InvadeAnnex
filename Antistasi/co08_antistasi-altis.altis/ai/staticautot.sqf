...
if (_grupo getVariable "staticAutoT") exitWith
	...
	if (typeOf _static == "B_G_Mortar_01_F") then {_grupo setvariable ["UPSMON_Removegroup",true]};
	sleep 5;
...
if (typeOf _static == "B_G_Mortar_01_F") exitWith {_nul=[_static] execVM "scripts\UPSMON\MON_artillery_add.sqf";};
