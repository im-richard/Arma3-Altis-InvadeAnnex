...
//_mrkfin setMarkerType "hd_pickup";
//_mrkfin setMarkerColor "ColorBlue";
//_mrkfin setMarkerText "NATO Ammodrop";
[] call playerIsOwner;
_tsk = ["NATOAmmo",true,["Our Commander asked NATO for an ammunition supply drop. Go there and pick those weapons.","NATO Ammodrop",_mrkfin],_posicion,"CREATED",5,true,true,"Support"] call BIS_fnc_setTask;
...
_helifn = [_orig, 0, "B_Heli_Transport_01_camo_F", WEST] call bis_fnc_spawnvehicle;
...
waitUntil {sleep 2; (currentWaypoint group _heli == 2) or (!canMove _heli)};

if (currentWaypoint group _heli == 2) then
	{
    ...
    [] call playerIsOwner;
    _tsk = ["NATOAmmo",true,["Our Commander asked NATO for an ammunition supply drop. Go there and pick those weapons.","NATO Ammodrop",_mrkfin],_posicion,"SUCCEEDED",5,true,true,"Support"] call BIS_fnc_setTask;
	...
	{
	[] call playerIsOwner;
	_tsk = ["NATOAmmo",true,["Our Commander asked NATO for an ammunition supply drop. Go there and pick those weapons.","NATO Ammodrop",_mrkfin],_posicion,"FAILED",5,true,true,"Support"] call BIS_fnc_setTask;
	};
